defmodule AbaViewerWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :info && "text-blue-800 bg-blue-50  ring-blue-500 fill-sky-900",
    ...
    >
      <p :if={@title} class="flex items-center gap-1.5 text-[0.8125rem] font-semibold leading-6">
        ...
        <Heroicons.check :if={@kind == :success} mini class="h-4 w-4" />
        <%= @title %>
      </p>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AbaViewerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AbaViewerWeb.Gettext, "errors", msg, opts)
    end
  end
